 ...
 * It also specifies {@link transitionIsModeled(State, Grounded)} method, which can be used to determine when the model is confident in its predictions from a given input state and action. This is useful for RMax
