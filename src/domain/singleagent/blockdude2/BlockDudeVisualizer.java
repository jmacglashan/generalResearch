package domain.singleagent.blockdude2;
...
/**
 * A state visualizer for {@link domain.singleagent.blockdude2.BlockDude}. The agent is a blue square with a gold eye
...
public class BlockDudeVisualizer {
	...
	/**
	 * Returns a {@link burlap.oomdp.visualizer.Visualizer} for {@link domain.singleagent.blockdude2.BlockDude}.
	 * @param maxx the max x dimensionality of the world
	 * @param maxy the max y dimensionality of the world
	 * @return a {@link burlap.oomdp.visualizer.Visualizer} for {@link domain.singleagent.blockdude2.BlockDude
	 */
	...
	/**
	 * Returns a {@link burlap.oomdp.visualizer.StateRenderLayer} for {@link domain.singleagent.blockdude2.BlockDudeVisualizer}.
	 * @param maxx the max x dimensionality of the world
	 * @param maxy the max y dimensionality of the world
	 * @return a {@link burlap.oomdp.visualizer.StateRenderLayer} for {@link domain.singleagent.blockdude2.BlockDudeVisualizer}.
	 */
	...
	public static class AgentPainter implements ObjectPainter {
		...
		public void paintObject(Graphics2D g2, State s, ObjectInstance ob,
			...
			float rx = ob.getDiscValForAttribute(domain.singleagent.blockdude.BlockDude.ATTX)*width;
			float ry = cHeight - height - ob.getDiscValForAttribute(domain.singleagent.blockdude.BlockDude.ATTY)*height;
			...
			float ex = rx;
			if(ob.getIntValForAttribute(domain.singleagent.blockdude.BlockDude.ATTDIR) == 1){
	...
	public static class BlockPainter implements ObjectPainter{
		...
		public void paintObject(Graphics2D g2, State s, ObjectInstance ob,
			...
			float rx = ob.getIntValForAttribute(domain.singleagent.blockdude.BlockDude.ATTX)*width;
			float ry = cHeight - height - ob.getDiscValForAttribute(domain.singleagent.blockdude.BlockDude.ATTY)*height;
