...
public class BlockDudeVisualizer {
	...
	public static Visualizer getVisualizer(int minx, int maxx, int miny, int maxy){
		
		Visualizer v = new Visualizer();
		
		v.addObjectClassPainter(BlockDude.CLASSAGENT, new AgentPainter(minx, maxx, miny, maxy));
		v.addObjectClassPainter(BlockDude.CLASSBLOCK, new BlockPainter(minx, maxx, miny, maxy));
		v.addObjectClassPainter(BlockDude.CLASSEXIT, new ExitPainter(minx, maxx, miny, maxy));
		v.addObjectClassPainter(BlockDude.CLASSPLATFORM, new PlatformPainter(minx, maxx, miny, maxy));
